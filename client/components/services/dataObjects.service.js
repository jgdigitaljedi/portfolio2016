	...
	function() {
		...
		var resumeObject = {
		    'experience':[
          {
            ...
            {
              'type':'Employment',
              'institution':'r4 Technologies',
              'title':'Front-End Engineer (remote)',
              'from':'2016-11-18',
              'to':null, /* because this is my current job, it doesn't have an end date */
              'description':'Design modular components in TypeScript then implement them into the main portal app.'+
              '\n Create many different types of widgets primarily using D3 for scalability.'+
              '\n All applications built in 100% custom framework to which I have made core contributions.',
              'default_item':true
            }
		    ],
		    'study':[
